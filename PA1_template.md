...
kable(Totals, caption = "Total number of steps per day", align = "l")
```
...
kable(mean.med, caption = "Mean and Median steps per day", align = "c")
```
...
kable(mean.med1, caption = "Mean and Median steps per day", align = "c")
```
